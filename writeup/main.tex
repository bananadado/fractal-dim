...
This entire paper is basically based on \cite{falconer2003}.\\
...
For a uniform IFS ($\forall i,\; r_i=r\in (0,1)$), the Moran equation gives $Nr^s=1$m hence $s=\log N/\log(1/r)$, which is the similarity dimension. A uniform IFS applies to all of your nice looking fractals. A non-uniform IFS (e.g. coastline) would have to have a numerical method of solving for this such as bisection or Newton's method.
\subsection{Examples}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.3\textwidth]{images/Hilbert_curve_1.svg.png}
    \caption{First iteration.}
    \label{fig:h1}
\end{figure}
\begin{figure}[h]
    \centering
    \includegraphics[width=0.3\textwidth]{images/Hilbert_curve_2.svg.png}
    \caption{Iterations 1 and 2.}
    \label{fig:h2}
\end{figure}
\begin{figure}[h]
    \centering
    \includegraphics[width=0.3\textwidth]{images/Hilbert_curve_3.svg.png}
    \caption{Iterations 1 to 3. \cite{img:example}}
    \label{fig:h3}
\end{figure}
